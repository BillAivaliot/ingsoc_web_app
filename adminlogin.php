...
<html lang="en">
 ...
 <div class="alert-danger">
     <h4 class="font-weight-bolder">WARNING! </h4>You are trying to access information available only to authorised personel. Any attempt by unauthorized persons to proceed farther is a crime and will be treated as such.
    </div>
      <div class="container text-center">
    <div class="row text-danger text-center">
     ...
     <div class="col-4">
         <form class = "form-signin" role = "form" action = "<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method = "post">
            ...
            name: <input type = "text" class = "form-control" name = "adminname" required autofocus></br>
  ...
  <?php if($_POST["adminname"]!="" && $_POST["password"]!=""){
